...
$(document).ready(function(){
        $('.planetes #two').click(function(){
            currentWorld =  2;
            if($('#circle_deux').hasClass('none')){
    ...
    function absolue2()
    {
        ...
        function preload() {
            ...
            game.load.image('background', 'images/fond2.jpg');
        ...
        function create() {
            ...
            // Creating some random Obstacles !
            setRandomInterval2();
            ...
            function setFireflies()
            {
                ...
                setTimeout(function(){
                    setFireflies();
                }, Math.floor(Math.random() * (7000 - 300) + 300));
            }
        ...
        function update()
        {
            ...
            if($('#canvas').css('display') !== 'none'){
                game.physics.arcade.overlap(player, obstacles, die2, null, this);
            }
        ...
        function die433 (player, obstacle) {
